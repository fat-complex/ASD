...
class TestInsertMethod(unittest.TestCase):
    def test_insert(self):
        ...
        ll7 = LinkedList.make(1, 2, 3, 4, 5)
        for val in [1, 2, 3, 4, 5]:
            ll7.insert(ll7.head, Node(val))
        self.assertEqual(to_values(ll7), [1, 5, 4, 3, 2, 1, 2, 3, 4, 5])
        self.assertEqual(ll7.len(), 10)

        ll8 = LinkedList.make(1, 2, 3, 4, 5)
        for val in [1, 2, 3, 4, 5]:
            ll8.insert(ll8.tail, Node(val))
...
class TestReverseMethod(unittest.TestCase):
    ...
    def test_reverse(self):
        ...
        ll2 = LinkedList.make(1)
        ll2.reverse()
        self.assertEqual(to_values(ll2), [1])
        self.assertEqual(ll2.len(), 1)
...
class TestHasLoopMethod(unittest.TestCase):
    def test_has_loop(self):
        ll1 = LinkedList.make(1, 2, 3, 4, 5)
        self.assertFalse(ll1.has_loop())

        ll2= LinkedList.make(1, 2, 3, 4, 5)
        point_node = ll2.head.next
        ll2.tail.next = point_node
        self.assertTrue(ll2.has_loop())

        ll3 = LinkedList.make()
        self.assertFalse(ll3.has_loop())

        ll4 = LinkedList.make(1)
        self.assertFalse(ll4.has_loop())

        ll4 = LinkedList.make(1)
        ll4.tail.next = ll4.head
        self.assertTrue(ll4.has_loop())
...
class TestSortMethod(unittest.TestCase):
    def test_sort(self):
        ...
        ll3 = LinkedList.make(1, 2)
        ll3.sort()
        self.assertEqual(to_values(ll3), [1, 2])

        ll4 = LinkedList.make(2, 1)
        ll4.sort()
        self.assertEqual(to_values(ll4), [1, 2])

        ll5 = LinkedList.make(5, 4, 3, 2, 1)
        ll5.sort()
        self.assertEqual(to_values(ll5), [1, 2, 3, 4, 5])

        ll6 = LinkedList.make(5, 1, 2, 4, 3)
        ll6.sort()
        self.assertEqual(to_values(ll6), [1, 2, 3, 4, 5])
...
class TestMergeMethod(unittest.TestCase):
    def test_emplace_merge(self):
        ll1 = LinkedList.make()
        ll2 = LinkedList.make(1, 2)
        ll1.merge(ll2)
        self.assertEqual(to_values(ll1), [1, 2])

        ll1 = LinkedList.make(1, 2)
        ll2 = LinkedList.make()
        ll1.merge(ll2)
        self.assertEqual(to_values(ll1), [1, 2])

        ll1 = LinkedList.make(1, 2, 3)
        ll2 = LinkedList.make(4, 5, 6)
        ll1.merge(ll2)
        self.assertEqual(to_values(ll1), [1, 2, 3, 4, 5, 6])

        ll1 = LinkedList.make(1, 3, 6)
        ll2 = LinkedList.make(2, 4, 5)
        ll1.merge(ll2)
        self.assertEqual(to_values(ll1), [1, 2, 3, 4, 5, 6])
